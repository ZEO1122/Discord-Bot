...
## 정의
- 배치 정규화는 미니배치 기준으로 중간값의 평균과 분산을 맞춘 뒤 다시 조정하는 층이다.
- 즉, 층마다 값의 규모를 안정화해 깊은 네트워크 학습을 수월하게 만드는 기법이다.
...
## 같이 보면 좋은 논문·글
- 설명글: Stanford / [CS231n Notes: Training Neural Networks Part 2](https://cs231n.github.io/neural-networks-3/)
- 설명글: PyTorch / [BatchNorm Documentation](https://docs.pytorch.org/docs/stable/generated/torch.nn.BatchNorm1d.html)
