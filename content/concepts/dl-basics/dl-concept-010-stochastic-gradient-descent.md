...
## 정의
- 확률적 경사하강법은 전체 데이터 대신 일부 샘플로 기울기를 근사해 자주 업데이트하는 방법이다.
- 즉, 노이즈는 있지만 계산이 가벼워 큰 데이터에서도 학습하기 쉬운 경사하강법이다.
...
## 같이 보면 좋은 논문·글
- 논문: Léon Bottou / [Stochastic Gradient Descent Tricks](https://www.microsoft.com/en-us/research/wp-content/uploads/2012/01/tricks-2012.pdf)
