...
## 정의
- LSTM은 정보를 남길지 버릴지를 게이트로 조절해 긴 의존관계를 다루는 RNN 계열 모델이다.
- 즉, 오래 기억할 내용과 바로 잊을 내용을 구분하도록 만든 순환신경망이다.
...
## 같이 보면 좋은 논문·글
- 설명글: Christopher Olah / [Understanding LSTM Networks](https://colah.github.io/posts/2015-08-Understanding-LSTMs/)
- 설명글: Dive into Deep Learning / [LSTM](https://d2l.ai/chapter_recurrent-modern/lstm.html)
