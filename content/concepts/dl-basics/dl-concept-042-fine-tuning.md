...
## 같이 보면 좋은 논문·글
- 논문: Jeremy Howard, Sebastian Ruder / [Universal Language Model Fine-tuning for Text Classification](https://arxiv.org/abs/1801.06146)
- 설명글: Hugging Face / [Fine-tuning a pretrained model](https://huggingface.co/docs/transformers/training)
