...
## 같이 보면 좋은 논문·글
- 설명글: PyTorch / [GRU Documentation](https://docs.pytorch.org/docs/stable/generated/torch.nn.GRU.html)
- 설명글: Keras / [GRU layer](https://keras.io/api/layers/recurrent_layers/gru/)
