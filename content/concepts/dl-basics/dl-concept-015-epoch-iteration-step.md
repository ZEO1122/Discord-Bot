...
## 정의
- 에폭은 전체 데이터를 한 바퀴 본 횟수이고, 이터레이션이나 스텝은 한 번의 업데이트 단위를 가리킨다.
- 즉, 학습 진행 정도를 말할 때 기준이 무엇인지 구분해 써야 하는 용어들이다.
...
## 같이 보면 좋은 논문·글
- 설명글: Google / [Machine Learning Glossary: epoch, batch size](https://developers.google.com/machine-learning/glossary)
- 설명글: PyTorch / [Training a Classifier Tutorial](https://docs.pytorch.org/tutorials/beginner/blitz/cifar10_tutorial.html)
