...
## 정의
- 경사하강법은 손실이 가장 빨리 줄어드는 방향의 반대로 조금씩 이동하는 최적화 방법이다.
- 즉, 지형의 기울기를 보고 낮은 곳으로 내려가듯 파라미터를 갱신하는 방식이다.
...
## 같이 보면 좋은 논문·글
- 논문: Léon Bottou / [Large-Scale Machine Learning with Stochastic Gradient Descent](https://leon.bottou.org/papers/bottou-2010)
