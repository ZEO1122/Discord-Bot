...
## 정의
- 사전학습은 큰 데이터에서 일반적인 패턴을 먼저 배우는 첫 학습 단계다.
- 즉, 기초 지식을 미리 익힌 뒤 나중에 특정 과제에 빠르게 적응하도록 만드는 준비 과정이다.
...
- 설명글: Lilian Weng / [Self-Supervised Representation Learning](https://lilianweng.github.io/posts/2019-11-10-self-supervised/)
