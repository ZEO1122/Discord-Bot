...
## 같이 보면 좋은 논문·글
- 설명글: Stanford / [CS231n Notes: Linear Classification](https://cs231n.github.io/linear-classify/)
- 설명글: Dive into Deep Learning / [Linear Regression](https://d2l.ai/chapter_linear-regression/linear-regression.html), [Softmax Regression](https://d2l.ai/chapter_linear-classification/softmax-regression.html)
