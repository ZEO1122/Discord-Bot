...
## 정의
- 미니배치는 한 번의 순전파와 역전파에 함께 넣는 작은 데이터 묶음이다.
- 즉, 전체 데이터와 한 개 샘플 사이의 중간 단위로 계산 효율과 안정성을 맞추는 방식이다.
...
## 같이 보면 좋은 논문·글
- 논문: Léon Bottou, Frank Curtis, Jorge Nocedal / [Optimization Methods for Large-Scale Machine Learning](https://arxiv.org/abs/1606.04838)
- 설명글: Dive into Deep Learning / [Minibatch SGD](https://d2l.ai/chapter_optimization/minibatch-sgd.html)
